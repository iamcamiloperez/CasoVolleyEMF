...
public class MatchupImpl extends MinimalEObjectImpl.Container implements Matchup {
	 ...
	 * @generated
	 */
	public EList getGames() {
		if (games == null) {
			games = new EObjectWithInverseResolvingEList(Game.class, this, BowlingPackage.MATCHUP__GAMES, BowlingPackage.GAME__MATCHUP);
		}
		return games;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BowlingPackage.MATCHUP__GAMES:
				return ((InternalEList)getGames()).basicAdd(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case BowlingPackage.MATCHUP__GAMES:
				getGames().clear();
				getGames().addAll((Collection)newValue);
				return;
		}
